...
public class PlazasFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    tiendaref.child("Plazas").orderByChild("idioma").equalTo(recibeDato).addValueEventListener(new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            for (DataSnapshot snapshot :
                ...
                PlazasFragment.this.propiedades.add(propiedades);
            }
