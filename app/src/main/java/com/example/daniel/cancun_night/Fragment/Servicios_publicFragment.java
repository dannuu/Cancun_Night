...
public class Servicios_publicFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public Servicios_publicFragment() {
    ...
    tiendaref.child("Servicios Publicos").orderByChild("idioma").equalTo(recibeDato).addValueEventListener(new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            for (DataSnapshot snapshot :
                ...
                Servicios_publicFragment.this.propiedades.add(propiedades);
            }
